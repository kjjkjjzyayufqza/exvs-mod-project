...
const multiMeshTreeXml = `<?xml version="1.0" encoding="utf-8"?>
<hkpackfile>
  <field name="objects">
    <array count="2" elementtypeid="type1">
      <record>
        <field name="meshTree">
          <record>
            <field name="domain">
              <record>
                <field name="min"><array count="4" elementtypeid="type48"><real dec="0" hex="0"/><real dec="0" hex="0"/><real dec="0" hex="0"/><real dec="1" hex="3f800000"/></array></field>
                <field name="max"><array count="4" elementtypeid="type48"><real dec="1" hex="3f800000"/><real dec="1" hex="3f800000"/><real dec="0" hex="0"/><real dec="1" hex="3f800000"/></array></field>
              </record>
            </field>
            <field name="sections">
              <array count="1" elementtypeid="type386">
                <record>
                  <field name="codecParms"><array count="6" elementtypeid="type48"><real dec="0" hex="0"/><real dec="0" hex="0"/><real dec="0" hex="0"/><real dec="1" hex="3f800000"/><real dec="1" hex="3f800000"/><real dec="1" hex="3f800000"/></array></field>
                  <field name="firstPackedVertexIndex"><integer value="0"/></field>
                  <field name="firstSharedVertexIndex"><integer value="0"/></field>
                  <field name="firstPrimitiveIndex"><integer value="0"/></field>
                  <field name="numPackedVertices"><integer value="3"/></field>
                  <field name="numPrimitives"><integer value="1"/></field>
                </record>
              </array>
            </field>
            <field name="packedVertices">
              <array count="3" elementtypeid="type33">
                <integer value="0"/>
                <integer value="1"/>
                <integer value="2048"/>
              </array>
            </field>
            <field name="sharedVerticesIndex"><array count="0" elementtypeid="type188"></array></field>
            <field name="sharedVertices"><array count="0" elementtypeid="type136"></array></field>
            <field name="primitives">
              <array count="1" elementtypeid="type388">
                <record>
                  <field name="indices">
      ...
      <record>
        <field name="meshTree">
          <record>
            <field name="domain">
              <record>
                <field name="min"><array count="4" elementtypeid="type48"><real dec="10" hex="41200000"/><real dec="0" hex="0"/><real dec="0" hex="0"/><real dec="1" hex="3f800000"/></array></field>
                <field name="max"><array count="4" elementtypeid="type48"><real dec="11" hex="41300000"/><real dec="1" hex="3f800000"/><real dec="0" hex="0"/><real dec="1" hex="3f800000"/></array></field>
              </record>
            </field>
            <field name="sections">
              <array count="1" elementtypeid="type386">
                <record>
                  <field name="codecParms"><array count="6" elementtypeid="type48"><real dec="10" hex="41200000"/><real dec="0" hex="0"/><real dec="0" hex="0"/><real dec="1" hex="3f800000"/><real dec="1" hex="3f800000"/><real dec="1" hex="3f800000"/></array></field>
                  <field name="firstPackedVertexIndex"><integer value="0"/></field>
                  <field name="firstSharedVertexIndex"><integer value="0"/></field>
                  <field name="firstPrimitiveIndex"><integer value="0"/></field>
                  <field name="numPackedVertices"><integer value="3"/></field>
...
describe("parseHavokXML", () => {
  ...
  it("aggregates multiple meshTree records into one preview mesh", () => {
    const data = parseHavokXML(multiMeshTreeXml);
    expect(data.quads).toHaveLength(2);
    expect(data.vertices).toHaveLength(6);
    expect(data.aabb).toEqual({
      min: [0, 0, 0],
      max: [11, 1, 0],
    });
  });
