  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid min-h-[360px] items-start gap-3 xl:grid-cols-[240px_minmax(0,1fr)]">
        <div className="flex min-h-0 flex-col gap-3 overflow-hidden rounded-md border bg-card/95 p-3 shadow-sm xl:sticky xl:top-0 xl:self-start xl:max-h-[calc(100dvh-7rem)]">
