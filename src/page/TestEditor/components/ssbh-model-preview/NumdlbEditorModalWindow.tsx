...
export function NumdlbEditorModalWindow({
  ...
  }, [onSave, session.draftData, session.loading, session.saving]);
      ...
      >
        ...
        >
          <Card className="flex max-h-[min(90vh,720px)] flex-col overflow-hidden border shadow-2xl">
            {/* Header — same structure as Fhm2dInitModal */}
            <div className="drag-handle flex shrink-0 cursor-move select-none items-center justify-between border-b bg-linear-to-r from-muted/80 to-muted/40 px-5 py-4">
            ...
            <CardContent className="flex min-h-0 flex-1 flex-col p-0">
              {session.loading ? (
                ...
                <div className="flex min-h-0 flex-1 flex-col">
                  ...
                  {/* Footer — same bar as Fhm2dInitModal */}
