          ...
          return (
            ...
            >
              <div className="min-w-0">
                ...
                <div className="mt-1 text-[11px] text-muted-foreground">{route.kind}</div>
              </div>
              ...
              <Button
                ...
                aria-label={`Reset ${route.label} prefix`}
                title={`Reset ${route.label} prefix`}
              >
