...
export const CHARACTER_STRING_FIELD_LABELS: Record<string, string> = {
  ...
  UnkStringOffset1: "variantDisplayNameDefault (0x68)",
  UnkStringOffset2: "variantDisplayNameSlot4 (0x7C)",
  UnkStringOffset3: "machineSelectWeaponText_SFIGHT (0x84)",
  UnkStringOffset4: "machineSelectWeaponText_MAIN (0x90)",
  UnkStringOffset5: "variantDisplayNameSlot3 (0x98)",
  UnkStringOffset6: "pilotNameShort (0xA4)",
  UnkStringOffset7: "machineSelectWeaponText_SP (0xB8)",
  UnkStringOffset8: "pilotNameFull (0xC0)",
  UnkStringOffset9: "machineSelectWeaponText_FIGHT (0x134)",
  UnkStringOffset10: "variantDisplayNameSlot1 (0x144)",
  UnkStringOffset11: "variantDisplayNameSlot5 (0x158)",
  UnkStringOffset12: "machineSelectWeaponText_SUB (0x18C)",
  UnkStringOffset13: "variantDisplayNameSlot6 (0x19C)",
  UnkStringOffset14: "variantDisplayNameSlot2 (0x1B0)",
};
