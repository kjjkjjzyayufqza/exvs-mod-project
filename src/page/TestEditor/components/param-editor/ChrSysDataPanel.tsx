        ...
        <div className="min-w-[640px] text-xs">
          ...
          <div className="rounded-b-md border bg-background">
            {data.entries.map((e, i) => (
              <div
                key={i}
                className="grid grid-cols-[minmax(0,1.2fr)_repeat(4,minmax(0,1fr))] gap-2 border-b border-border/40 px-3 py-2 transition-colors last:border-0 hover:bg-muted/50"
              >
