...
export class CharacterDataOB {
  ...
  // 0x100 empty
  // 0x104 empty
  unkId12: number; // 0x108
  // 0x10c empty
  ms_tracker: number; // 0x110
  UnkHash14: number; // 0x114
  // 0x118 empty
  UnkHash15: number; // 0x11c
  // 0x120 empty
  UnkHash16: number; // 0x124
  // 0x128 empty
  UnkHash17: number; // 0x12c
  UnkStringOffset9: StringNameData; // 0x130
  // 0x134 empty
  UnkHash18: number; // 0x138 //不知道是什么，有8个.bin
  MS_card_icon_index: number; // 0x13c
  UnkStringOffset10: StringNameData; // 0x140
  // 0x144 empty
  UnkHash19: number; // 0x148
  unkId13: number; // 0x14c
  UnkHash20: number; // 0x150
  UnkStringOffset11: StringNameData; // 0x154
  // 0x158 empty
  LMBCutIn: number; // 0x15c
  sticker_t05: number; // 0x160
  SeriesId: number; // 0x164
  // 0x168 empty
  UnkHash21: number; // 0x16c //不知道是什么，有8个.bin
  // 0x170 empty
  // 0x174 empty
  // 0x178 empty
  ms_ms_l: number; // 0x17c
  // 0x180 empty
  vs_p_r: number; // 0x184
  UnkStringOffset12: StringNameData; // 0x188
  // 0x18c empty
  LMBBoost: number; // 0x190
  UnkHash22: number; // 0x194
  UnkStringOffset13: StringNameData; // 0x198
  // 0x19c empty
  rnk_m_l: number; // 0x1a0
  // 0x1a4 empty
  ms_crs: number; // 0x1a8
  UnkStringOffset14: StringNameData; // 0x1ac
  // 0x1b0 empty
  // 0x1b4 empty
  UnkHash23: number; // 0x1b8
  ms_ms_s: number; // 0x1bc
  vs_p_l: number; // 0x1c0
  // 0x1c4 empty
  ms_mn: number; // 0x1c8
  sc_p: number; // 0x1cc
  unkId14: number; // 0x1d0
