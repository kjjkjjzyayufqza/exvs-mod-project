...
export class CharacterDataOB {
  ...
  ms_igh_r: string; // 0xc
  ms_vs_r: string; // 0x10
  UnkHash1: string; // 0x14
  CharacterNameOffset: StringNameData; // 0x18
  UnkId3: number; // 0x1c
  UnkId4: number; // 0x20
  UnkId5: number; // 0x24
  UnkId6: number; // 0x28
  UnkHash2: string; // 0x2c
  ms_vs_l: string; // 0x30
  UnkId7: number; // 0x34
  UnkHash3: string; // 0x38
  UnkHash4: string; // 0x3c
  UnkHash5: string; // 0x40
  UnkHash6: string; // 0x44
  UnkHash7: string; // 0x48
  UnkHash8: string; // 0x4c
  UnkId8: number; // 0x50
