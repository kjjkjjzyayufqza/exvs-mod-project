...
export class CharacterDataOB {
  ...
  // 0x60 empty
  UnkHash7: number // 0x64
  UnkStringOffset1: StringNameData // 0x68
  // 0x6c empty
  // 0x70 empty
  UnkHash8: number // 0x74
  ...
  UnkHash14: number // 0x118
  // 0x11c empty
  UnkHash15: number // 0x120
  // 0x124 empty
  UnkHash16: number // 0x128
  // 0x12c empty
  UnkHash17: number // 0x130
  UnkStringOffset9: StringNameData // 0x134
  // 0x138 empty
  UnkHash18: number // 0x13c //不知道是什么，有8个.bin
  MS_card_icon_index: number // 0x140
  UnkStringOffset10: StringNameData // 0x144
  // 0x148 empty
  UnkHash19: number // 0x14c
  unkId15: number // 0x150
  UnkHash20: number // 0x154
  ...
  // 0x16c empty
  UnkHash21: number // 0x170 //不知道是什么，有8个.bin
  // 0x174 empty
  // 0x178 empty
  // 0x17c empty
  ...
  constructor (buffer: Buffer, startBufferData: Buffer, CharacterId: number) {
    ...
    this.UnkHash14 = StreamReader.readInt32LE(0x118)
    this.UnkHash15 = StreamReader.readInt32LE(0x120)
    this.UnkHash16 = StreamReader.readInt32LE(0x128)
    this.UnkHash17 = StreamReader.readInt32LE(0x130)
    this.UnkStringOffset9 = new StringNameData(StreamReader.readInt32LE(0x134), buffer)
    this.UnkHash18 = StreamReader.readInt32LE(0x13c)
    ...
    this.UnkHash19 = StreamReader.readInt32LE(0x14c)
    this.unkId15 = StreamReader.readInt32LE(0x150)
    this.UnkHash20 = StreamReader.readInt32LE(0x154)
    ...
    this.UnkHash21 = StreamReader.readInt32LE(0x170)
    ...
    this.UnkHash22 = StreamReader.readInt32LE(0x198)
    ...
    this.UnkHash23 = StreamReader.readInt32LE(0x1bc)
...
export function CharacterListOBOutPut (characterList: CharacterListOB, path: string) {
  ...
  for (let i = 0; i < characterList.CharacterData.length; i++) {
    ...
    unitDataBuffer.writeInt32LE(char.UnkHash7, baseOffset + 0x64)
    ...
    unitDataBuffer.writeInt32LE(char.UnkHash8, baseOffset + 0x74)
    ...
    unitDataBuffer.writeInt32LE(char.UnkHash9, baseOffset + 0xb4)
    ...
    unitDataBuffer.writeInt32LE(char.UnkHash10, baseOffset + 0xcc)
    unitDataBuffer.writeInt32LE(char.vs_p_r_c02, baseOffset + 0xd0)
    unitDataBuffer.writeInt32LE(char.unkId9, baseOffset + 0xd4)
    unitDataBuffer.writeInt32LE(char.UnkHash11, baseOffset + 0xd8)
    unitDataBuffer.writeInt32LE(char.sticker_t01, baseOffset + 0xe0)
    unitDataBuffer.writeInt32LE(char.UnkHash12, baseOffset + 0xe4)
    unitDataBuffer.writeInt32LE(char.UnkHash13, baseOffset + 0xe8)
    ...
    unitDataBuffer.writeInt32LE(char.UnkHash14, baseOffset + 0x118)
    // 0x11c empty
    unitDataBuffer.writeInt32LE(char.UnkHash15, baseOffset + 0x120)
    // 0x124 empty
    unitDataBuffer.writeInt32LE(char.UnkHash16, baseOffset + 0x128)
    // 0x12c empty
    unitDataBuffer.writeInt32LE(char.UnkHash17, baseOffset + 0x130)
    ...
    unitDataBuffer.writeInt32LE(char.UnkHash18, baseOffset + 0x13c)
    ...
    unitDataBuffer.writeInt32LE(char.UnkHash19, baseOffset + 0x14c)
    unitDataBuffer.writeInt32LE(char.unkId15, baseOffset + 0x150)
    unitDataBuffer.writeInt32LE(char.UnkHash20, baseOffset + 0x154)
    ...
    // 0x16c empty
    unitDataBuffer.writeInt32LE(char.UnkHash21, baseOffset + 0x170)
    // 0x174 empty
    // 0x178 empty
    // 0x17c empty
    ...
    unitDataBuffer.writeInt32LE(char.UnkHash22, baseOffset + 0x198)
    ...
    // 0x1b4 empty
    // 0x1b8 empty
    unitDataBuffer.writeInt32LE(char.UnkHash23, baseOffset + 0x1bc)
