...
CLUSTERS: tuple[Cluster, ...] = (
    ...
    Cluster(
        ...
        settled=(
            ...
            "Awakening HUD swap is func_879 -> func_1034(3/4) (TWINBUSTERRIFLE_EX / FLYING_EX). That BindSlot is MS-bar only. Bird HUD is rebellion_bird_weapon_bar_installed, not global143: dash cut_in_loop installs the bird bar with global143=0. While the latch is set, the global770 edge reinstalls the bird bar. E1 2026-09-06, L3 untested. See wing-zero-rebellion-flight-burst-weapon-bar.md.",
        ),
        do_not=(
