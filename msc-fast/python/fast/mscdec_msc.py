...
COMMAND_UNPACK_FROM = {
    cmd: struct.Struct(">" + fmt).unpack_from
...
class MscFile:
    ...
    def readFromFile(self, f, headerEndianess = '>'):
        ...
        first_sorted_index = {}
        for i, offset in enumerate(sortedScriptOffsets):
            if offset not in first_sorted_index:
                first_sorted_index[offset] = i
        count = 0
