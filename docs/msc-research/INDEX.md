...
- **kind:** global
- **aliases:** `BD`, `boost dash`, `step`, `sys_46`, `func_11`, `0xc000`, `boost gate`, `global23`, `speedparam movement`, `func_158`, `recoil`, `后坐力`, `func_351`, `冲到天上`
- **settled:**
...
- **kind:** global
- **aliases:** `speedparam`, `characterparam`, `armsparam`, `bulletparam`, `sys_0 0x60006`, `lock-on`, `red lock`, `param evidence`, `fieldBb93d195`, `0xBB93D195`, `weapon icon`
- **settled:**
...
- **kind:** global
- **aliases:** `sys_51`, `strikertable`, `striker table`, `516001001`, `0xFEEB79F0`, `independent striker`, `CBattleStrikerManager`, `完全独立援护`, `独立机体召唤`, `d0001`, `d000b`, `0xd0001`, `0xd000b`, `ACTION_AB_SUB`, `0x53554243`, `d0003`, `0xd0003`, `ACTION_MASK_UNKNOWN`, `0x4ac375c7`, `0x2a253f72`, `sys_51 type`, `action index`, `7CE3B6`, `0x7CE3B6`, `7CE240`, `sub_1407CE240`, `CAcSeqBattleFlow_Player`, `0x2C284`, `CBattleStatusManager`, `sub_1405BF290`, `sub_1405C1750`, `11格`, `对战费用表`, `vs HUD crash`, `对战崩溃`, `对战崩`, `召唤就崩`, `rank_root`
...
- **read_first:**
  ...
  - `docs/msc-research/vs-player-hud-cost-index-oob.md`
- **related:**
...
- **read_first:**
  ...
  - `docs/msc-research/wing-zero-rebellion-unused-form-reload-group-b.md`
  - `docs/msc-research/wing-zero-rebellion-flight-burst-weapon-bar.md`
- **docs:**
  ...
  - `docs/msc-research/wing-zero-rebellion-zero-system-once-per-life.md`
  - `docs/msc-research/wing-zero-rebellion-bird-slot1-assist-lock.md`
  - `docs/msc-research/wing-zero-rebellion-flight-burst-weapon-bar.md`
- **related:**
...
- **kind:** unit
- **aliases:** `Hambrabi`, `ハンブラビ`, `002zgundm_006hambrb_001`, `変形サブ射撃`, `側転射撃`, `前進射撃`, `背部ビームライフル`, `roll shot`, `side roll`, `func_969`, `func_1082`, `func_1083`, `func_1085`, `func_1086`, `func_1088`, `func_1089`, `0x9940F95A`, `0x2986D9F6`, `0xF6FD193E`, `func_1182`, `func_873`, `func_988`, `func_849`, `0x700000`, `chrsysparam action matrix`, `SUB_SHOT_FLIGHT_ROLL_L`, `SUB_SHOT_FLIGHT_ROLL_R`, `0x5346534c`, `0x53465352`
- **settled:**
