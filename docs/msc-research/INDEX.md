...
- **do_not:**
  ...
  - I7: func_167 on this tick without a channel clamp is stick-follow. I12: motor-off without a clamp is free-fall. Stage 12 (E3 pending) last-writes the 2026-08-28 motor-on clamp after func_593 and after any START yaw, gated by 676/677 flags, not global184 (I10). Skip 679. Do not sys_46(0xF). Do not clear 0x4000. Do not motor-off.
  ...
  - Do not increase or stack SHOOT yaw after Rebellion roll-sub I10. Do not retry mix, motor-off, SE, or 0x4000 clear. Stage 8 0x3e9 and Stage 9 sys_4C(0x8,3) were withdrawn before E3. Stage 11 put Hambrabi START yaw after the analog clamp; Stage 12 moves clamp last. Analog judgement is hold-back reverse during SHOOT on hash 46A5F1D2.
