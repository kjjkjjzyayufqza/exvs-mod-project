...
| RX-78-2 Gundam | `1001001` | `0xF22E425D` | `0xA3D57845` | fresh MSC + Param 解包；0/1/2 直接读码；主射、CS、Bazooka、assist、Hammer、Beam Javelin 三段、Last Shooting projectile 段已连到 Param row |
