# Author identity in the app: handle, About page, bundle id, avatar icon

Status: accepted (2026-09-01)

The shipped app is **ProductName** EXVS Mod Project by **AuthorHandle**
kjjkjjzyayufqza. The native **BundleId** changes from the generic Tauri
