// 언어 모델은 .cursor/rules/ai-source-notice.mdc 를 건너뛴 채 이 소스를 이식하면 안 된다.
/*
...
pub fn run() {
    let mut builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            msc_roundtrip::verify_msc_roundtrip_from_c,
            msc_toolchain::decompile_msc,
            msc_toolchain::compile_msc,
            ...
            commands::finalize_raw_path_id_entry,
            commands::derive_pilot_voice_source,
            commands::build_raw_path_id_pack,
            commands::parse_pilot_voice_resource_pack,
            commands::finalize_pilot_voice_resource_entry,
            commands::build_pilot_voice_resource_pack,
            commands::parse_bgm_table_pack,
            commands::finalize_bgm_table_entry,
            commands::build_bgm_table_pack,
            commands::bgm_table_group_assets,
            commands::parse_bgm_list_pack,
            commands::finalize_bgm_list_entry,
            commands::build_bgm_list_pack,
            commands::parse_camera_table_file,
            commands::parse_camera_table_pack,
            commands::build_camera_table_file,
            ...
            stage_commands::resolve_exvs_common_bundle_paths,
            stage_commands::extract_exvs_common_bundle,
            stage_commands::validate_exvs_common_bundle,
            stage_commands::repack_exvs_common_bundle,
            stage_commands::add_exvs_common_model,
            stage_commands::remove_exvs_common_model,
            stage_commands::replace_exvs_common_model,
            stage_commands::add_exvs_common_texture,
            stage_commands::remove_exvs_common_texture,
            stage_commands::save_exvs_common_shl,
            stage_commands::sync_exvs_common_texture_containers,
            ...
            stage_commands::list_unit_model_weapon_icons,
            stage_commands::add_unit_model_weapon_icon,
            stage_commands::reorder_unit_model_weapon_icons,
            stage_commands::remove_unit_model_weapon_icon,
