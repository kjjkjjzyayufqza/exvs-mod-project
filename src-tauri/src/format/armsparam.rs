...
impl ParamEntryWithId for ArmsParamEntry {
...
pub type ArmsParamData = TypedParamBundle<ArmsParamEntry>;

pub fn parse_armsparam(data: &[u8]) -> Result<ArmsParamData, String> {
    parse_typed_param_binary(data, ARMSPARAM_ENTRY_SIZE, ARMSPARAM_CMD_COUNT)
}
