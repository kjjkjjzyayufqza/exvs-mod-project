...
impl ParamEntryWithId for HitGroupIdDefEntry {
...
pub type HitGroupIdDefData = TypedParamBundle<HitGroupIdDefEntry>;

pub fn parse_hitgroupiddef(data: &[u8]) -> Result<HitGroupIdDefData, String> {
    parse_typed_param_binary(data, HITGROUPIDDEF_ENTRY_SIZE, HITGROUPIDDEF_CMD_COUNT)
}
