...
impl ParamEntryWithId for InteractionIdEntry {
...
pub type InteractionIdData = TypedParamBundle<InteractionIdEntry>;

pub fn parse_interactionid(data: &[u8]) -> Result<InteractionIdData, String> {
    parse_typed_param_binary(data, INTERACTIONID_ENTRY_SIZE, INTERACTIONID_CMD_COUNT)
}
