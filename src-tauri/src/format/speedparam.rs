...
impl ParamEntryWithId for SpeedParamEntry {
...
pub type SpeedParamData = TypedParamBundle<SpeedParamEntry>;

pub fn parse_speedparam(data: &[u8]) -> Result<SpeedParamData, String> {
    parse_typed_param_binary(data, SPEEDPARAM_ENTRY_SIZE, SPEEDPARAM_CMD_COUNT)
}
